(function() {	'use strict';	var flipAsset = document.getElementById('flip-require').getAttribute('flip-asset'),		repository = flipAsset + '/repository';	require.config({
	"paths": {
		"thunder": repository + "/thunder/1.2.1/thunder.min",
		...
		"thunderUi": repository + "/thunder/1.2.1/thunder.ui.min",
		"thunderWizard": repository + "/thunder/1.2.1/thunder.wizard.min",
		"socketIO": repository + "/socket.io/1.0.6/socket.io.min",
		"thunderSocket": repository + "/thunder/1.2.1/thunder.socket.min",
		...
		"thunderWt": repository + "/thunder/1.2.1/thunder.wt.min"
	},
	"shim": {
		"thunder": {
			"deps": [
