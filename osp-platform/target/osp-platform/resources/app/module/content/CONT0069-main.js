require([ 'cont0069-service','osp-ui-app','small-modal' ,'form2object','osp-util',
          'flip', 'common-util', 'cookie'], function(cont0069_Service,uiApp) {
	
	$("input[name='file']").on('change', function(e) {
		var id = "uploadContent";

		cont0069_Service.chooseFile(id);
	});
