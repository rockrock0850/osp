  		...
  		<div class="row">
    		<div class="col-md-6" style='margin-left: 25%;'>
      			...
      			<c:if test="${IS_DEV_MODE}">
	      			...
	      			<div class="form-group">
	        			<label class="control-label visible-ie8 visible-ie9">groupId</label>
	        			<div class="input-icon">
	        				<select id="groupId" name="groupId" class="form-control placeholder-no-fix">
	        					<option value="900000044">900000044 / BSOM-Activation-Member</option>
	        					<option value="900000045">900000045 / BSOM-Activation-Leader</option>
	        					<option value="900000046">900000046 / BSOM-Activation-Manager</option>
	        					<option value="900000053">900000053 / BSOM-Activation-Director</option>
	        				</select>
	        			</div>
	      			</div>
      			</c:if>
