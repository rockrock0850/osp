...
/**
 * SysNotificationMain generated by hbm2java
 */
@Entity
@Table(name="SYS_NOTIFICATION_MAIN")
public class SysNotificationMain  implements java.io.Serializable {
    ...
    public SysNotificationMain() {
    }

	
    public SysNotificationMain(String notifyMainId, String notifyType, String notifyFunc, String hasSend, Date createDate, String createUser) {
    ...
    public SysNotificationMain(String notifyMainId, String notifyType, String notifyFunc, String emailRecipients, String emailCpRecipients, String smsRecipients, String hasSend, String subject, String content, Date sendDate, Date createDate, String createUser, Date updateDate, String updateUser) {
       this.notifyMainId = notifyMainId;
       this.notifyType = notifyType;
       this.notifyFunc = notifyFunc;
