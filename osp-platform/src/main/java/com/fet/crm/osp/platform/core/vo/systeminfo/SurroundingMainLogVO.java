 ...
 * @author LawrenceLai
 */
public class SurroundingMainLogVO {
	...
	private List<SurroundingDetailLogVO> detailLogList;
	...
	public List<SurroundingDetailLogVO> getDetailLogList() {
		return detailLogList;
	}

	public void setDetailLogList(List<SurroundingDetailLogVO> detailLogList) {
