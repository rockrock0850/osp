(function() {
	 ...
	 * 2014-02-12
	 *   本版本最主要異動為：
	 *   1、將AngularJS升級至1.2.12
	 *   2、額外再讀入angular-route.js
	 *   3、承第2點，須再額外匯入其module name : ngRoute
	 *     ex:
	 *        angular.module('thunderApp', ['ui.bootstrap.modal', 'ngRoute'.....
	 */
	...
	define('flip', ["text", "angularUi", "bootstrapDropdown",
						  ...
						  "ajaxfileupload", "angularRoute"], function() {
        return this;
    });
}).call(this);