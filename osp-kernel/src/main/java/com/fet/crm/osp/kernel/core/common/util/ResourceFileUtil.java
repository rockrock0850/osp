...
public enum ResourceFileUtil {
    ...
    JSON("json", ""), // json檔案
    CSV("csv", ""), // csv檔案
    SQL_ORDER("sql", "order"), // SQL檔案, sql/order資料夾
    SQL_OSP("sql", "osp"), // SQL檔案, sql/osp資料夾
    SQL_SYSTEM("sql", "system"), // SQL檔案, sql/system資料夾
    SQL_ORGANIZATION("sql", "organization"); // SQL檔案, sql/system資料夾
