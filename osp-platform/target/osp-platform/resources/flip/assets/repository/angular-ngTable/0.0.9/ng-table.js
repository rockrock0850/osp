        ...
        this.generatePagesArray = function (currentPage, totalItems, pageSize) {
            ...
            if (numPages > 1) {
				...
				*/
				...
				// 在頁面上顯示10頁可供選擇
				minPage = (currentPage - 5 > 0 ? currentPage - 5 : 1);
				maxPage = (minPage + 9 >= numPages ? numPages : minPage + 9);
...
angular.module('ngTable').run(['$templateCache', function ($templateCache) {
	...
	$templateCache.put('ng-table/pager.html', '<div class="pagination pagination-small" style="text-align: center"><ul><li ng-repeat="page in pages" ng-switch="page.type"><a ng-switch-when="first" ng-click="params.page(page.number)" href="">&laquo; 第一頁</a><a ng-switch-when="prev" ng-click="params.page(page.number)" href="">&lt; 上一頁</a><a ng-switch-when="page" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a><a ng-switch-when="next" ng-click="params.page(page.number)" href="">下一頁&gt;</a>	<a ng-switch-when="last" ng-click="params.page(page.number)" href="">最後一頁&raquo;</a> </li></ul></div>');
