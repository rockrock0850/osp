 ...
 * @author LawrenceLai
 */
public class CacheSubscriberInfoVO {
	...
	/**
	 * @param contractComponentId
	 *            the contractComponentId to set
	 */
	...
	/**
	 * @param accountContractComponentId
	 *            the accountContractComponentId to set
	 */
	...
	/**
	 * @param adminFldNmTpCd
	 *            the adminFldNmTpCd to set
	 */
	...
	/**
	 * @param lastMsisdnUpdateDt
	 *            the lastMsisdnUpdateDt to set
	 */
	...
	/**
	 * @param lastSubStActivity
	 *            the lastSubStActivity to set
	 */
	...
	/**
	 * @param subStReasonDesr
	 *            the subStReasonDesr to set
	 */
