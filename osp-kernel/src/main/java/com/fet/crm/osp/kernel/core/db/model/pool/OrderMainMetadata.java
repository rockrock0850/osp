package com.fet.crm.osp.kernel.core.db.model.pool;
...
public class OrderMainMetadata implements java.io.Serializable {
    ...
    public OrderMainMetadata(String poolKey, String sourceOrderId, String teamGroup, String sourceSysId,
            String criticalFlag, Date sourceCreateTime, BigDecimal counts, Date expectProcessTime, Date createDate,
            String createUser) {
    ...
    public OrderMainMetadata(String poolKey, String sourceOrderId, String teamGroup, String sourceSysId,
            String sourceProdTypeId, String operateType, String criticalFlag, Date sourceCreateTime, String msisdn,
            String custName, String imgIdApid, String partentOrderId, BigDecimal counts, Date expectProcessTime,
            Date custSpecifyDate, String custId, String salesId, String ivrCode, String promotionId,
            String imgStorePath, String imgStoreServer, String cid, String status, String processUser,
            String sysSyncBatchNo, Date createDate, String createUser, Date updateDate, String updateUser) {
        this.poolKey = poolKey;
        this.sourceOrderId = sourceOrderId;
        this.teamGroup = teamGroup;
        this.sourceSysId = sourceSysId;
