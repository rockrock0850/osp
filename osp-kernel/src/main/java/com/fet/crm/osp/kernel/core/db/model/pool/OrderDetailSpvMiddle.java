...
/**
 * OrderDetailSpvMiddle generated by hbm2java
 */
@Entity
@Table(name = "ORDER_DETAIL_SPV_MIDDLE")
public class OrderDetailSpvMiddle implements java.io.Serializable {
	...
	public OrderDetailSpvMiddle() {
	}

	public OrderDetailSpvMiddle(String orderDId, String poolKey, String sourceOrderId, Date createDate) {
	...
	public OrderDetailSpvMiddle(String orderDId, String poolKey, String sourceOrderId, String accountId, String msisdn,
